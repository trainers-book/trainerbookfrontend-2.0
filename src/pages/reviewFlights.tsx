...
const ReviewFlights: React.FC = () => {
  ...
  const [selectedDate, setSelectedDate] = useState<{ minDate: Date; maxDate: Date }>();
  ...
  const getPlatformsAndFilters = () => {
    ...
    if (selectedDate) {
      filters.minDate = selectedDate.minDate.getTime();
      filters.maxDate = selectedDate.maxDate.getTime();
    }
    return {
